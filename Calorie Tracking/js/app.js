...
class Meal {
   constructor(name, calories){
      this.id = Math.random().toString(16).slice(2);  //make hexadecimal random number, you can also use date time stamp for random id
      this.name = name;
...
class Storage {
   ...
   static clearAll() {
      ...
      // if you want calorie limit to stay
